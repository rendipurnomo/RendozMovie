...
export default function SubscriptionCard({id, name,price, durationInMounth, features, isPremium, onSelectSubscription}) {
  return (
    <div>
    {/* Basic */}
    {!isPremium && (<div
...
{isPremium && (<div
                        ...
                        <div>
                            ...
                            <p className="text-[#767676] text-xs font-light">/{durationInMounth} months</p>
                        </div>
