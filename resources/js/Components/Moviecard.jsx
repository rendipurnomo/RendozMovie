...
export default function Moviecard({
  ...
  return (
    <div className="absolute group overflow-hidden mr-7">
                            <img src={thumbnail}
                                className="object-cover rounded-3xl h-60 w-44" alt=""/>
                            <div
                                className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-3xl rounded-br-3xl">
                                <div className="px-6 pb-3">
                                    <div className="font-medium text-md text-white">{name}</div>
                                    <p className="mb-0 text-gray-300 text-xs mt-1">{category}</p>
                                </div>
                            </div>
